/************************************************************************
	filename: 	WLTabButton.h
	created:	03/12/2004
	author:		Paul D Turner
	
	purpose:	Defines interface for Windows Look Tab Button class.
*************************************************************************/
/*************************************************************************
...
*************************************************************************/
#ifndef _WLTabButton_h_
#define _WLTabButton_h_
...
/*!
\brief
	Concrete TabButton class for the Windows Look widget set.	
*/
class WINDOWSLOOK_API WLTabButton : public TabButton
{
public:
    /*************************************************************************
    Constants
	...
	*************************************************************************/
	/*!
	\brief
		Constructor for Windows Look TabButton objects.
	...
	*/
	WLTabButton(const String& type, const String& name);
...
/*!
\brief
	Factory class for producing WLTabButton objects
*/
class WINDOWSLOOK_API WLTabButtonFactory : public WindowFactory
{
public:
	/*************************************************************************
		Construction and Destruction
	*************************************************************************/
	/*!
	\brief
		Constructor for Windows Tab Button factory class.
	*/
	WLTabButtonFactory(void) : WindowFactory(WLTabButton::WidgetTypeName) { }


	/*
	\brief
		Destructor for Windows Tab Button factory class.
	*/
	~WLTabButtonFactory(void){}
