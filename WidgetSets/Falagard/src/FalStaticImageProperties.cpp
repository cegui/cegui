...
{
    return PropertyHelper::imageToString(static_cast<const FalagardStaticImage*>(receiver)->getImage());
}

void    Image::set(PropertyReceiver* receiver, const String& value)
{
    static_cast<FalagardStaticImage*>(receiver)->setImage(PropertyHelper::stringToImage(value));
}
