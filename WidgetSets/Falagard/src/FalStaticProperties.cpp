...
{
	return PropertyHelper::boolToString(static_cast<const FalagardStatic*>(receiver)->isFrameEnabled());
}


void	FrameEnabled::set(PropertyReceiver* receiver, const String& value)
{
	static_cast<FalagardStatic*>(receiver)->setFrameEnabled(PropertyHelper::stringToBool(value));
}


String	BackgroundEnabled::get(const PropertyReceiver* receiver) const
{
	return PropertyHelper::boolToString(static_cast<const FalagardStatic*>(receiver)->isBackgroundEnabled());
}


void	BackgroundEnabled::set(PropertyReceiver* receiver, const String& value)
{
	static_cast<FalagardStatic*>(receiver)->setBackgroundEnabled(PropertyHelper::stringToBool(value));
}
