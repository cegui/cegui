...
namespace CEGUI
{
    const utf8 TLTooltip::WidgetTypeName[] = "TaharezLook/Tooltip";

    TLTooltip::TLTooltip(const String& type, const String& name) :
            Tooltip(type, name),
            d_backgroundCols(0x00FFFFFF, 0x00FFFFFF, 0x00FFFFFF, 0x00FFFFFF),
            d_frameCols(0x00FFFFFF, 0x00FFFFFF, 0x00FFFFFF, 0x00FFFFFF)
    {}

    void TLTooltip::initialise(void)
    {
        Tooltip::initialise();

        Imageset* iset = ImagesetManager::getSingleton().getImageset("TaharezLook");
    ...
    void TLTooltip::drawSelf(float z)
    {
    ...
    void TLTooltip::onSized(WindowEventArgs& e)
    {
    ...
    void TLTooltip::onAlphaChanged(WindowEventArgs& e)
    {
