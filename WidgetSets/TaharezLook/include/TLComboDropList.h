...
*************************************************************************/
#ifndef _TLComboDropList_h_
#define _TLComboDropList_h_
...
*/
class TAHAREZLOOK_API TLComboDropList : public ComboDropList
{
public:
	/*************************************************************************
		Constants
...
*/
class TAHAREZLOOK_API TLComboDropListFactory : public WindowFactory
{
public:
	/*************************************************************************
		Construction and Destruction
	*************************************************************************/
	TLComboDropListFactory(void) : WindowFactory((utf8*)"Taharez ComboDropList") { }
