...
namespace CEGUI
{
    ...
    */
    class CEGUIBASE_API AbsoluteDim : public BaseDim
    {
    public:
        /*!
        \brief
    ...
    */
    class CEGUIBASE_API ImageDim : public BaseDim
    {
    public:
        /*!
        \brief
    ...
    */
    class CEGUIBASE_API WidgetDim : public BaseDim
    {
    public:
        /*!
        \brief
    ...
    */
    class CEGUIBASE_API UnifiedDim : public BaseDim
    {
    public:
        /*!
        \brief
    ...
    */
    ...
    \brief
        ...
        represent.
    */
    class CEGUIBASE_API ComponentArea
    {
    public:
        /*!
        \brief
