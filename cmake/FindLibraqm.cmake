...
find_path(LIBRAQM_H_PATH NAMES raqm.h PATH_SUFFIXES libraqm/src)
...
# set up output vars
if (LIBRAQM_FOUND)
    set (LIBRAQM_INCLUDE_DIR ${LIBRAQM_H_PATH})
    set (LIBRAQM_LIBRARIES ${LIBRAQM_LIB})
    if (LIBRAQM_LIB_DBG)
        set (LIBRAQM_LIBRARIES_DBG ${LIBRAQM_LIB_DBG})
    endif()
    if (LIBRAQM_LIB_STATIC)
        set (LIBRAQM_LIBRARIES_STATIC ${LIBRAQM_LIB_STATIC})
    endif()
    if (LIBRAQM_LIB_STATIC_DBG)
        set (LIBRAQM_LIBRARIES_STATIC_DBG ${LIBRAQM_LIB_STATIC_DBG})
    endif()
else()
    set (LIBRAQM_INCLUDE_DIR)
    set (LIBRAQM_LIBRARIES)
    set (LIBRAQM_LIBRARIES_DBG)
    set (LIBRAQM_LIBRARIES_STATIC)
    set (LIBRAQM_LIBRARIES_STATIC_DBG)
endif()
