...
macro(clear_if_changed TESTVAR)
  ...
  if (NOT "${${TESTVAR}}" STREQUAL "${${TESTVAR}_INT_CHECK}")
    ...
    foreach(var ${ARGN})
      # Don't pollute the cache with variables that didn't exist before the check
      get_property(IS_IN_CACHE CACHE ${var} PROPERTY TYPE) # TODO: since CMake 3.14 can use "if (DEFINED CACHE{${var}})"
      if (IS_IN_CACHE)
