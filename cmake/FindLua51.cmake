...
find_library(LUA_LIB NAMES lua5.1 lua51 lua-5.1 lua PATH_SUFFIXES dynamic/${CEGUI_ARCH_SUFFIX})
find_library(LUA_LIB_DBG NAMES lua5.1_d lua51_d lua-5.1_d lua_d PATH_SUFFIXES dynamic/${CEGUI_ARCH_SUFFIX})
mark_as_advanced(LUA_H_PATH LUA_LIB LUA_LIB_DBG)

if (WIN32 OR APPLE)
    find_library(LUA_LIB_STATIC NAMES lua5.1 lua51 lua-5.1 lua PATH_SUFFIXES static/${CEGUI_ARCH_SUFFIX})
    find_library(LUA_LIB_STATIC_DBG NAMES lua5.1_d lua51_d lua-5.1_d lua_d PATH_SUFFIXES static/${CEGUI_ARCH_SUFFIX})
