...
struct TypedProperty_less__CEGUI_scope_String__greater__wrapper : CEGUI::TypedProperty< CEGUI::String >, bp::wrapper< CEGUI::TypedProperty< CEGUI::String > > {
    ...
    TypedProperty_less__CEGUI_scope_String__greater__wrapper(::CEGUI::String const & name, ::CEGUI::String const & help, ::CEGUI::String const & origin="Unknown", ::CEGUI::String const & defaultValue=T(), bool writesXML=true )
    : CEGUI::TypedProperty<CEGUI::String>( boost::ref(name), boost::ref(help), boost::ref(origin), boost::ref(defaultValue), writesXML )
      , bp::wrapper< CEGUI::TypedProperty< CEGUI::String > >(){
        // constructor
...
void register_TypedPropertyString_class(){
    ...
    { //::CEGUI::TypedProperty< CEGUI::String >
        ...
        TypedPropertyString_exposer_t TypedPropertyString_exposer = TypedPropertyString_exposer_t( "TypedPropertyString", bp::init< CEGUI::String const &, CEGUI::String const &, bp::optional< CEGUI::String const &, CEGUI::String const &, bool > >(( bp::arg("name"), bp::arg("help"), bp::arg("origin")="Unknown", bp::arg("defaultValue")=T(), bp::arg("writesXML")=(bool)(true) ), "TODO: do we want less bug prone code but a bit slower (string conversion for default values at\
        construction) or faster\n\
