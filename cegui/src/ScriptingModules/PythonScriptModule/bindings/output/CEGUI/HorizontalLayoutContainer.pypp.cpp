    ...
    { //::CEGUI::HorizontalLayoutContainer
        ...
        *\n") );
        ...
        { //::CEGUI::LayoutContainer::getUnclippedInnerRect_impl
            ...
            typedef ::CEGUI::Rect< float > ( HorizontalLayoutContainer_wrapper::*default_getUnclippedInnerRect_impl_function_type )(  ) const;
        ...
        { //::CEGUI::Window::isHit
            ...
            typedef bool ( HorizontalLayoutContainer_wrapper::*default_isHit_function_type )( ::CEGUI::Vector2< float > const &,bool const ) const;
