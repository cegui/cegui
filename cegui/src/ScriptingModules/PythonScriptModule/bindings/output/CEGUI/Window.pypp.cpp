...
struct Window_wrapper : CEGUI::Window, bp::wrapper< CEGUI::Window > {
    ...
    virtual bool testClassName_impl( ::CEGUI::String const & class_name ) const {
        if( bp::override func_testClassName_impl = this->get_override( "testClassName_impl" ) )
            ...
            return this->CEGUI::Window::testClassName_impl( boost::ref(class_name) );
        }
    }
    
    virtual bool default_testClassName_impl( ::CEGUI::String const & class_name ) const {
        return CEGUI::Window::testClassName_impl( boost::ref(class_name) );
    }
...
void register_Window_class(){
    ...
    { //::CEGUI::Window
        ...
        { //::CEGUI::Window::testClassName_impl
        
            typedef bool ( Window_wrapper::*testClassName_impl_function_type )( ::CEGUI::String const & ) const;
            
            Window_exposer.def( 
                "testClassName_impl"
                , testClassName_impl_function_type( &Window_wrapper::default_testClassName_impl )
                , ( bp::arg("class_name") )
                , "*!\n\
                \n\
                    Return whether this window was inherited from the given class name at\n\
