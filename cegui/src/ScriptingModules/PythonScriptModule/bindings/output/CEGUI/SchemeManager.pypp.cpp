...
void register_SchemeManager_class(){
    ...
    { //::CEGUI::SchemeManager
        ...
        { //::CEGUI::SchemeManager::getIterator
            ...
            typedef ::CEGUI::ConstBaseIterator< std::map<CEGUI::String, CEGUI::Scheme*, CEGUI::String::FastLessCompare, CEGUI::STLAllocatorWrapper<std::pair<CEGUI::String, CEGUI::Scheme*>, CEGUI::StdAllocator> > > ( ::CEGUI::SchemeManager::*getIterator_function_type )(  ) const;
