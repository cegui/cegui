...
struct GUISheet_wrapper : CEGUI::GUISheet, bp::wrapper< CEGUI::GUISheet > {

    GUISheet_wrapper(::CEGUI::String const & type, ::CEGUI::String const & name )
    : CEGUI::GUISheet( boost::ref(type), boost::ref(name) )
      , bp::wrapper< CEGUI::GUISheet >(){
        // constructor
...
void register_GUISheet_class(){
    ...
    { //::CEGUI::GUISheet
        typedef bp::class_< GUISheet_wrapper, bp::bases< CEGUI::Window >, boost::noncopyable > GUISheet_exposer_t;
        GUISheet_exposer_t GUISheet_exposer = GUISheet_exposer_t( "GUISheet", "*!\n\
        \n\
        ...
        \n\
            note\n\
            The C++ name of this class has been retained for backward compatibility reasons.  The intended\
            usage of\n\
        ...
        *\n") );
        bp::scope GUISheet_scope( GUISheet_exposer );
        { //::CEGUI::Window::beginInitialisation
        
            typedef void ( ::CEGUI::Window::*beginInitialisation_function_type )(  ) ;
            typedef void ( GUISheet_wrapper::*default_beginInitialisation_function_type )(  ) ;
            
            GUISheet_exposer.def( 
                "beginInitialisation"
                , beginInitialisation_function_type(&::CEGUI::Window::beginInitialisation)
                , default_beginInitialisation_function_type(&GUISheet_wrapper::default_beginInitialisation) );
        
        }
        { //::CEGUI::Window::cloneChildWidgetsTo
        
            typedef void ( ::CEGUI::Window::*cloneChildWidgetsTo_function_type )( ::CEGUI::Window & ) const;
            typedef void ( GUISheet_wrapper::*default_cloneChildWidgetsTo_function_type )( ::CEGUI::Window & ) const;
            
            GUISheet_exposer.def( 
                "cloneChildWidgetsTo"
                , cloneChildWidgetsTo_function_type(&::CEGUI::Window::cloneChildWidgetsTo)
                , default_cloneChildWidgetsTo_function_type(&GUISheet_wrapper::default_cloneChildWidgetsTo)
                , ( bp::arg("target") ) );
        ...
        { //::CEGUI::Window::clonePropertiesTo
            ...
            typedef void ( GUISheet_wrapper::*default_clonePropertiesTo_function_type )( ::CEGUI::Window & ) const;
            
            GUISheet_exposer.def( 
                "clonePropertiesTo"
                , clonePropertiesTo_function_type(&::CEGUI::Window::clonePropertiesTo)
                , default_clonePropertiesTo_function_type(&GUISheet_wrapper::default_clonePropertiesTo)
                , ( bp::arg("target") ) );
        ...
        { //::CEGUI::Window::destroy
            ...
            typedef void ( GUISheet_wrapper::*default_destroy_function_type )(  ) ;
            
            GUISheet_exposer.def( 
                "destroy"
                , destroy_function_type(&::CEGUI::Window::destroy)
                , default_destroy_function_type(&GUISheet_wrapper::default_destroy) );
        
        }
        { //::CEGUI::Window::endInitialisation
        
            typedef void ( ::CEGUI::Window::*endInitialisation_function_type )(  ) ;
            typedef void ( GUISheet_wrapper::*default_endInitialisation_function_type )(  ) ;
            
            GUISheet_exposer.def( 
                "endInitialisation"
                , endInitialisation_function_type(&::CEGUI::Window::endInitialisation)
                , default_endInitialisation_function_type(&GUISheet_wrapper::default_endInitialisation) );
        
        }
        { //::CEGUI::EventSet::fireEvent
        
            typedef void ( ::CEGUI::EventSet::*fireEvent_function_type )( ::CEGUI::String const &,::CEGUI::EventArgs &,::CEGUI::String const & ) ;
            typedef void ( GUISheet_wrapper::*default_fireEvent_function_type )( ::CEGUI::String const &,::CEGUI::EventArgs &,::CEGUI::String const & ) ;
            
            GUISheet_exposer.def( 
                "fireEvent"
                , fireEvent_function_type(&::CEGUI::EventSet::fireEvent)
                , default_fireEvent_function_type(&GUISheet_wrapper::default_fireEvent)
        ...
        { //::CEGUI::Window::getRenderingContext_impl
            ...
            typedef void ( GUISheet_wrapper::*default_getRenderingContext_impl_function_type )( ::CEGUI::RenderingContext & ) const;
            
            GUISheet_exposer.def( 
                "getRenderingContext_impl"
                , getRenderingContext_impl_function_type(&::CEGUI::Window::getRenderingContext_impl)
                , default_getRenderingContext_impl_function_type(&GUISheet_wrapper::default_getRenderingContext_impl)
                , ( bp::arg("ctx") ) );
        ...
        { //::CEGUI::Window::getUnclippedInnerRect_impl
            ...
            typedef ::CEGUI::Rect ( GUISheet_wrapper::*default_getUnclippedInnerRect_impl_function_type )(  ) const;
            
            GUISheet_exposer.def( 
                "getUnclippedInnerRect_impl"
                , getUnclippedInnerRect_impl_function_type(&::CEGUI::Window::getUnclippedInnerRect_impl)
                , default_getUnclippedInnerRect_impl_function_type(&GUISheet_wrapper::default_getUnclippedInnerRect_impl) );
        
        }
        { //::CEGUI::Window::initialiseComponents
        
            typedef void ( ::CEGUI::Window::*initialiseComponents_function_type )(  ) ;
            typedef void ( GUISheet_wrapper::*default_initialiseComponents_function_type )(  ) ;
            
            GUISheet_exposer.def( 
                "initialiseComponents"
                , initialiseComponents_function_type(&::CEGUI::Window::initialiseComponents)
                , default_initialiseComponents_function_type(&GUISheet_wrapper::default_initialiseComponents) );
        
        }
        { //::CEGUI::Window::isHit
        
            typedef bool ( ::CEGUI::Window::*isHit_function_type )( ::CEGUI::Vector2 const &,bool const ) const;
            typedef bool ( GUISheet_wrapper::*default_isHit_function_type )( ::CEGUI::Vector2 const &,bool const ) const;
            
            GUISheet_exposer.def( 
                "isHit"
                , isHit_function_type(&::CEGUI::Window::isHit)
                , default_isHit_function_type(&GUISheet_wrapper::default_isHit)
        ...
        { //::CEGUI::Window::performChildWindowLayout
            ...
            typedef void ( GUISheet_wrapper::*default_performChildWindowLayout_function_type )( bool,bool ) ;
            
            GUISheet_exposer.def( 
                "performChildWindowLayout"
                , performChildWindowLayout_function_type(&::CEGUI::Window::performChildWindowLayout)
                , default_performChildWindowLayout_function_type(&GUISheet_wrapper::default_performChildWindowLayout)
        ...
        { //::CEGUI::Window::setLookNFeel
            ...
            typedef void ( GUISheet_wrapper::*default_setLookNFeel_function_type )( ::CEGUI::String const & ) ;
            
            GUISheet_exposer.def( 
                "setLookNFeel"
                , setLookNFeel_function_type(&::CEGUI::Window::setLookNFeel)
                , default_setLookNFeel_function_type(&GUISheet_wrapper::default_setLookNFeel)
                , ( bp::arg("look") ) );
        ...
        { //::CEGUI::Window::setMargin
            ...
            typedef void ( GUISheet_wrapper::*default_setMargin_function_type )( ::CEGUI::UBox const & ) ;
            
            GUISheet_exposer.def( 
                "setMargin"
                , setMargin_function_type(&::CEGUI::Window::setMargin)
                , default_setMargin_function_type(&GUISheet_wrapper::default_setMargin)
                , ( bp::arg("margin") ) );
        ...
        { //::CEGUI::EventSet::subscribeScriptedEvent
            ...
            typedef ::CEGUI::RefCounted< CEGUI::BoundSlot > ( GUISheet_wrapper::*default_subscribeScriptedEvent_function_type )( ::CEGUI::String const &,::CEGUI::String const & ) ;
            
            GUISheet_exposer.def( 
                "subscribeScriptedEvent"
                , subscribeScriptedEvent_function_type(&::CEGUI::EventSet::subscribeScriptedEvent)
                , default_subscribeScriptedEvent_function_type(&GUISheet_wrapper::default_subscribeScriptedEvent)
        ...
        { //::CEGUI::EventSet::subscribeScriptedEvent
            ...
            typedef ::CEGUI::RefCounted< CEGUI::BoundSlot > ( GUISheet_wrapper::*default_subscribeScriptedEvent_function_type )( ::CEGUI::String const &,unsigned int,::CEGUI::String const & ) ;
        ...
        { //::CEGUI::Window::update
            ...
            typedef void ( GUISheet_wrapper::*default_update_function_type )( float ) ;
            
            GUISheet_exposer.def( 
                "update"
                , update_function_type(&::CEGUI::Window::update)
                , default_update_function_type(&GUISheet_wrapper::default_update)
                , ( bp::arg("elapsed") ) );
        ...
        { //::CEGUI::Window::writeXMLToStream
            ...
            typedef void ( GUISheet_wrapper::*default_writeXMLToStream_function_type )( ::CEGUI::XMLSerializer & ) const;
            
            GUISheet_exposer.def( 
                "writeXMLToStream"
                , writeXMLToStream_function_type(&::CEGUI::Window::writeXMLToStream)
                , default_writeXMLToStream_function_type(&GUISheet_wrapper::default_writeXMLToStream)
                , ( bp::arg("xml_stream") ) );
