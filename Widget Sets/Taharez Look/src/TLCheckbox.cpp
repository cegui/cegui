...
/*************************************************************************
	Set the colour to use for the Checkbox text when rendering in the
	normal state.	
*************************************************************************/
void TLCheckbox::setNormalTextColour(colour colour)
{
...
*************************************************************************/
void TLCheckbox::setHoverTextColour(colour colour)
{
...
/*************************************************************************
	...
	pushed state.
*************************************************************************/
void TLCheckbox::setPushedTextColour(colour colour)
{
...
/*************************************************************************
	...
	disabled state.	
*************************************************************************/
void TLCheckbox::setDisabledTextColour(colour colour)
{
